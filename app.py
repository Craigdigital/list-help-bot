...
def creatDraft(parameters):
    ...
    url = "http://0e29c665.ngrok.io/experience/consumer_selling/v1/listing_draft/create_and_open?mode=AddItem"
...
def updateItem(draftId,data,startPrice):
    ...
    url = "http://0e29c665.ngrok.io/experience/consumer_selling/v1/listing_draft/" + str(draftId) + "?mode=AddItem"
...
def publishItem(draftId, paypal_account):
    ...
    url = "http://0e29c665.ngrok.io/experience/consumer_selling/v1/listing_draft/" + str(draftId) + "/publish?mode=AddItem"
